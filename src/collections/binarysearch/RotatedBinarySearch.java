...
public class RotatedBinarySearch {
    public static void main(String[] args) {
        ...
        int[] duplicates = {2, 2, 2, 3, 3, 3, 5, 0, 1, 1, 2};
        System.out.println(findPivotWithDuplicates(duplicates));
    ...
    static int search(int[] arr, int target) {
        ...
        // if pivot was found, it means there are 2 sorted arrays
        if (arr[pivot] == target) {
            return pivot;
        }
        if (target >= arr[0]) {
    ...
    //this method will not work if array contains duplicate values
